          ...
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between h-12 text-xs">
              ...
              <nav className="hidden md:flex items-center gap-4 text-zinc-400">
                <Link href="/topics/congress" className="hover:text-white transition-colors py-2">Congress</Link>
                ...
                <Link href="/newsletter" className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 text-xs font-bold uppercase tracking-wide transition-colors min-w-[44px] min-h-[44px] inline-flex items-center justify-center">
                  Subscribe
                </Link>
                <button 
              ...
              <div className="lg:hidden absolute top-full left-0 right-0 bg-black border-b border-zinc-800 z-50">
                <div className="container mx-auto px-4 py-4">
                  ...
                  <div className="border-t border-zinc-800 mt-4 pt-4 space-y-2">
                    ...
                    <Link href="/newsletter" className="text-zinc-400 hover:text-white transition-colors text-sm block py-2">Subscribe</Link>
                  </div>
                </div>
              </div>
            )}
